...
function Header() {
 ...
 const{MenuToggle,Menu}=useHeroContax()
  ...
  return (
    <>
          <div className='w-[100%]  '>
            <div className='w-[100%] bg-hero-image h-[100vh] md:h-[80vh] z-0'>
                <div className=' w-[82%]  mx-auto 2xl:ml-[210px] xl:ml-[210px]  z-0    bg-red-20 flex items-center justify-between   h-[108px]   '>
                       
                      <div className='   flex items-center justify-between w-[73%] z-0'>
                ...
                <div className=' absolute sm:top-[180px]  xs:top-[180px] top-[120px]    md:top-16  w-[75%]  h-[500px]  left-[13%] xl:h-[80vh] grid grid-cols-[1fr,1fr] grid-rows-1 sm:grid-cols-1 sm:grid-rows-2 xs:grid-cols-1 xs:grid-rows-2 '>
                    <div className='  text-nowrap '>
              
                      <div className=' absolute w-[20%] opacity-40 left-[52%] top-[20%] h-[180px] bg-red-600 xs:hidden sm:hidden md:hidden'>
                     
                      </div>
                      <p className=' text-[65px] md:text-[45px]  xs:text-[24px] sm:text-[30px] lg:text-[50px] xs:top-[-60px] left-[1%] sm:top-[-60px] font-bold text-white absolute sm:left-[8%] xs:left-[0%] top-32 tracking-[2px] xs:tracking-normal mini:text-red-500'>TASTE   THE  AUTHENTIC</p><br/>
            ...
            <div className=' w-[300px]   relative sm:mt-[-110vh] xs:mt-[-100vh]  mt-[-100vh]  h-[100vh] z-30 '>
                 {Menu&&<MenuSection/>} 
            </div>
        </div>
