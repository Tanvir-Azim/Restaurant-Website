...
function HeroSection() {
  ...
  return (
    <div className=' w-[100%] h-[650px] mt-20 '>
        <div className='w-[75%] h-full mx-auto  sm:h-[170vh] xs:h-[170vh]  '>
            ...
            <div className='  h-[100px] w-[100%] grid grid-cols-3 grid-rows-1 mt-[-20px]  sm:mt-1 sm:grid-cols-1  sm:grid-rows-3 sm:h-52 xs:h-52 xs:grid-cols-1  xs:grid-rows-3'>
